...
-- SE REINICIAN LAS SECUENCIAS SEGÚN LOS DATOS INICIALES (PARA QUE NO SE GENEREN ERRORES Y SE PUEDAN INSERTAR NUEVOS DATOS PARTIENDO DE LOS ID'S DE LOS DATOS INICIALES)
